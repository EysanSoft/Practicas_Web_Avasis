        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a
                  class="dropdown-item" href="../Practica_1/views/ejemplos_bs.html">Demo Boostrap</a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="../Practica_2/index.php">Práctica 2 / Tabla y Dropdown</a>
          </li>
          <li class="nav-item dropdown">
            <a
              class="nav-link dropdown-toggle"
