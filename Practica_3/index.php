          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="../Practica_1/index.php"
                    >Peticiones con JS & PHP</a
                  >
                </li>
                <li>
                  <a
                    class="dropdown-item"
                    href="../Practica_1/views/ejemplos_bs.html"
                    >Demo Boostrap</a
                  >
                </li>
              </ul>
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item active" href="./index.html"
                    >Formulario con Jquery Submit</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="./views/ejemplos_jquery.html"
                    >Demo Jquery</a
                  >
                </li>
              </ul>
    ...
    <div class="row mx-5 mt-5 justify-content-center">
      <div class="col-3">
        ...
        >
          ...
          <div class="mb-3">
            <label for="conContra" class="form-label"
